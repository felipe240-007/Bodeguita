...
from src.views.form_jefe_bodega import MasterPanel
...
class login:
    ...
    def verificar(self):
        ...
        if usuario == '' or password == '':
            messagebox.showwarning(title="Mensaje", message="Ingrese usuario y contrasena")
            return

        id_rol = self.controller.verificar_credenciales(usuario, password)
        ...
        if id_rol is not None:
            ...
            messagebox.showerror(message="La contrasena no es correcta", title="Mensaje")
